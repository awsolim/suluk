    ...
    Tables: {
      ...
      program_payment_terms: {
        Row: {
          ...
          superseded_by_payment_terms_id: string | null;
          internal_note: string | null;
          created_at: string;
          updated_at: string;
        };
        Insert: Partial<Database["public"]["Tables"]["program_payment_terms"]["Row"]>;
        Update: Partial<Database["public"]["Tables"]["program_payment_terms"]["Row"]>;
        Relationships: [];
      };
      withdrawal_requests: {
        Row: {
